...
class CategoryModel(models.Model):
    ...
    # 分类的图片
    image = models.CharField(max_length=100,null=False,verbose_name='分类的展示图片',default='/static/images/banner01.jpg')
    class Meta:
        db_table = 'category'
        verbose_name = '商品分类'
...
class GoodsModel(models.Model):
    ...
    price = models.DecimalField(default=0,max_digits=11,decimal_places=2,null=False,verbose_name='商品价格')
    #单位
...
# 商品分类和商品关系model categoryGoods 字段category_id goods_id
...
class ImagesModel(models.Model):
    # 储存图片与商品的关系
    goods = models.ForeignKey(GoodsModel,on_delete=models.CASCADE,verbose_name='商品')
    image_url = models.CharField(max_length=255, verbose_name='图片地址', null=False)
